...
// Universell: nutzt Joybus-API, wenn verfügbar, sonst alte mempak_* API.
...
/* Fallback-Makros, falls Joybus-Header sie nicht definiert */
#if USE_JOYBUS
...
#if USE_JOYBUS
    /* Joybus-Variante braucht kein controller_init() */
#else
    controller_init();
#endif
